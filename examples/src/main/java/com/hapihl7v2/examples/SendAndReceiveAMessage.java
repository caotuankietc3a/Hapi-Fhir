...
public class SendAndReceiveAMessage {
   ...
   */
  public SendAndReceiveAMessage() throws Exception {
  ...
  public static class MyExceptionHandler
     ...
     *            Any metadata that accompanies the incoming message. See {@link
     * ca.uhn.hl7v2.protocol.Transportable#getMetadata()}
     ...
     *         another message. <b>This method may not return
     * <code>null</code></b>.
     */
    public String processException(String theIncomingMessage,
       ...
       * so, or just return the NAK which HAPI already created
       * (theOutgoingMessage)
       */
