 ...
 * GPL are applicable instead of those above.  If you wish to allow use of your
 ...
 * provisions required by the GPL License. If you do not delete the provisions
...
public class ExampleReceiverApplication
   ...
   * {@inheritDoc}
   */
  public boolean canProcess(Message theIn) { return true; }
